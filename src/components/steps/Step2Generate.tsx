...
import { Copy, Check, Download, ChevronRight, ChevronLeft, Wand2, Building2, User, Layers, FileText, AlertCircle } from 'lucide-react';
...
export const Step2Generate: React.FC<Step2Props> = ({ config, onBack, onNext }) => {
  ...
  useEffect(() => {
    setPrompt(buildExecutionPrompt(config));
  }, [config]);
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">{config.industry}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">{config.jobTitle}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">{selectedSeniority?.label}</p>
                  <p className="text-xs text-gray-500 mt-0.5 italic">{selectedSeniority?.tone}</p>
                </div>
              </div>
              ...
              {config.policyText.trim() && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 font-medium">Policy Patch</p>
                    <p className="text-sm font-semibold text-emerald-700">
                      ✓ {config.policyText.trim().split(/\s+/).length} words injected
                    </p>
                  </div>
                </div>
              )}
